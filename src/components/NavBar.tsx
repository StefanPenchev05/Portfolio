  ...
  return (
    <nav className="flex justify-between items-center border-b-2 px-8 py-4">
      ...
      {isMenuOpen && (
        <>
          <div
            className="xl:hidden fixed inset-0 bg-black opacity-50 transition-opacity duration-300"
            aria-hidden="true"
            onClick={() => setIsMenuOpen(false)}
          ></div>
          <div className="xl:hidden fixed left-0 top-0 w-96 p-8 h-full bg-[#191b1e] z-50 transform transition-transform duration-300">
            <Button
